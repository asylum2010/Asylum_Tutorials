...
// helper macros
#define TITLE				"Shader sample 71: Vulkan basic example"
...
bool InitScene()
{
	...
	VulkanRenderText("Hello Vulkan!", helptext);
	...
	VulkanTemporaryCommandBuffer(true, true, [&](VkCommandBuffer transfercmd) -> bool {
		VulkanPipelineBarrierBatch barrier(VK_PIPELINE_STAGE_TRANSFER_BIT, VK_PIPELINE_STAGE_TRANSFER_BIT);
		{
			...
			barrier.ImageLayoutTransition(texture, VK_ACCESS_SHADER_READ_BIT, VK_IMAGE_ASPECT_COLOR_BIT, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, 0, 0, 0, 0);
